...
def keys_pressed(d_o_e=tkinter.dooneevent, #d_o_e=Tkinter.tkinter.dooneevent
                 d_w=tkinter.DONT_WAIT): #d_w=Tkinter.tkinter.DONT_WAIT
    d_o_e(d_w)
    if _got_release:
      d_o_e(d_w)
...
def remove_from_screen(x,
                       d_o_e=tkinter.dooneevent, #d_o_e=Tkinter.tkinter.dooneevent
                       d_w=tkinter.DONT_WAIT): #d_w=Tkinter.tkinter.DONT_WAIT
    _canvas.delete(x)
    d_o_e(d_w)
